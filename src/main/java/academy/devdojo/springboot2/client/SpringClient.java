...
public class SpringClient {
    public static void main(String[] args){
        ...
        ResponseEntity<List<Anime>> exchange1 = new RestTemplate().exchange("http://localhost:8080/animes/all",
                HttpMethod.GET,
                null,
                new ParameterizedTypeReference<>() {});
        //@formatter:on
        log.info(exchange.getBody());
        log.info(exchange1.getBody());

//        Anime kingdom = Anime.builder().name("kigdom").build();
